<template>
  <div class="flex flex-col h-full">
    ...
    <div class="px-2 py-4 border-b border-gray-200 dark:border-gray-700 md:hidden">
      <ProjectSelector />
    </div>
    ...
    <nav class="flex-1 px-2 py-4 space-y-1">
      ...
      >
        ...
        <span
          v-if="item.badge"
          class="ml-auto inline-block py-0.5 px-2 text-xs bg-gray-100 dark:bg-gray-700 rounded-full"
        >
          {{ item.badge }}
        </span>
      </NuxtLink>
    ...
    <div class="px-2 py-4 border-t border-gray-200 dark:border-gray-700">
      <div class="flex items-center px-2 py-2 text-sm text-gray-600 dark:text-gray-400">
